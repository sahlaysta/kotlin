...
internal fun areAnnotationsEqual(a: AnnotationDescriptor, b: AnnotationDescriptor): Boolean = areExpressionConstValuesEqual(a, b)

private fun areExpressionConstValuesEqual(a: Any?, b: Any?): Boolean {
    return when {
