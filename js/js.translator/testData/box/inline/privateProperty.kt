...
private class A {
    ...
    // CHECK_NOT_CALLED_IN_SCOPE: function=get_p12_vcxd78_k$ scope=box IGNORED_BACKENDS=JS
    // CHECK_NOT_CALLED_IN_SCOPE: function=set_p12_5hx3iv_k$ scope=box IGNORED_BACKENDS=JS
    ...
    // CHECK_FUNCTION_EXISTS: get_p13_fu5dkl_k$ IGNORED_BACKENDS=JS
    // CHECK_NOT_CALLED_IN_SCOPE: function=get_p13_fu5dkl_k$ scope=box IGNORED_BACKENDS=JS
    // CHECK_CALLED_IN_SCOPE: function=set_p13_oqooig_k$ scope=box IGNORED_BACKENDS=JS
    var Int.p13: Int
    ...
    // CHECK_CALLED_IN_SCOPE: function=get_p14_bddxy_k$ scope=box IGNORED_BACKENDS=JS
    // CHECK_FUNCTION_EXISTS: set_p14_r1nsh3_k$ IGNORED_BACKENDS=JS
    // CHECK_NOT_CALLED_IN_SCOPE: function=set_p14_r1nsh3_k$ scope=box IGNORED_BACKENDS=JS
    var Int.p14: Int
